...
RSpec.describe TTY::Markdown, ".parse" do
  context "when Markdown" do
    context "when ATX" do
      it "converts level 1 to 3 headings" do
        markdown = <<-TEXT
# Heading 1
...
Text after the level 3 heading.
      ...
      it "converts level 1 to 3 headings with the custom heading1 style" do
        markdown = <<-TEXT
# Heading 1
Text after the level 1 heading.
...
Text after the level 3 heading.
      ...
      it "converts level 1 to 3 headings with the custom header style" do
        markdown = <<-TEXT
# Heading 1
Text after the level 1 heading.
