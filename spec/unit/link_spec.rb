...
[I'm an inline-style link](https://www.google.com)
    ...
    expect(parsed).to eq("I’m an inline-style link » \e[33;4mhttps://www.google.com\e[0m\n")
  end
...
[I'm an inline-style link with title](https://www.google.com "Google's Homepage")
    TEXT
    parsed = TTY::Markdown.parse(markdown, color: :always, symbols: :unicode)
    expect(parsed).to eq("I’m an inline-style link with title » (Google's Homepage) \e[33;4mhttps://www.google.com\e[0m\n")
  end
